...
export default function Card(
    ...
    return (
        <motion.div className={cardWrapperClassName} whileHover={!disabled && !readOnly ? {scale: 1.15} : {}}>
            <Button
                onClick={onClick}
                ...
                className={`flex items-center justify-center text-zinc-800 w-full h-full text-xl lg:text-2xl font-bold border border-zinc-700 dark:border-zinc-200 rounded shadow-lg transition-transform duration-300 ${
                    readOnly ? 'bg-zinc-200 dark:bg-zinc-700' : disabled ? 'bg-gray-200' : 'bg-green-200 hover:bg-blue-300'
